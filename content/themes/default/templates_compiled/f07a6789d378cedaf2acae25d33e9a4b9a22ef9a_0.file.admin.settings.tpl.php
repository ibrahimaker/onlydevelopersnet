<?php
/* Smarty version 4.1.1, created on 2022-09-26 14:24:55
  from '/home/u0725988/public_html/content/themes/default/templates/admin.settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6331b637892e02_01177361',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f07a6789d378cedaf2acae25d33e9a4b9a22ef9a' => 
    array (
      0 => '/home/u0725988/public_html/content/themes/default/templates/admin.settings.tpl',
      1 => 1653391142,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:__svg_icons.tpl' => 116,
  ),
),false)) {
function content_6331b637892e02_01177361 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="card">
...
<span class='d-none d-md-inline'><br><?php echo __("Show what user is followings (Friends, Followings, Pages... etc)");?>
</span></div></div>"><?php echo __("Default");?>
</option>
...
<span class='d-none d-md-inline'><br><?php echo __("All posts will be shown");?>
</span></div></div>"><?php echo __("All Posts");?>
</option>
            </select>
            <span class="form-text">
...
<span class='d-none d-md-inline'><br><?php echo __("Anyone one can see the post");?>
</span></div></div>"><?php echo __("Public");?>
</option>
...
<span class='d-none d-md-inline'><br><?php echo __("Only post author friends can see the post");?>
</span></div></div>"><?php echo __("Friends");?>
</option>
...
<span class='d-none d-md-inline'><br><?php echo __("Only post author can see the post");?>
</span></div></div>"><?php echo __("Only Me");?>
</option>
            </select>
          </div>
        </div>
...
?>
              ...
              <div>
                <div class="form-control-label h6"><?php echo __("Activation Required");?>
</div>
...
?><strong class="ml5 pr5"><?php echo __("Wasabi");?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="#Google" data-toggle="tab">
            <i class="fab fa-google fa-fw mr5"></i><strong class="ml5 pr5"><?php echo __("Google Cloud");?>
</strong>
          </a>
        </li>
        <li class="nav-item">
...
<span class='d-none d-md-inline'><br><?php echo __('High quality photos with low compression');?>
</span></div></div>"><?php echo __("High Quality");?>
</option>
...
<span class='d-none d-md-inline'><br><?php echo __('Medium quality photos with medium compression');?>
</span></div></div>"><?php echo __("Medium Quality");?>
</option>
...
<span class='d-none d-md-inline'><br><?php echo __('Low quality photos with high compression');?>
</span></div></div>"><?php echo __("Low Quality");?>
</option>
                </select>
              </div>
            </div>
        ...
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=google_cloud">
          <div class="card-body">
            <div class="alert alert-primary">
              ...
              <div class="text">
                <strong><?php echo __("Google Cloud");?>
</strong><br>
                <?php echo __("Before enabling Google Cloud, make sure you upload the whole 'uploads' folder to your bucket");?>
.<br>
                <?php echo __("Before disabling Google Cloud, make sure you download the whole 'uploads' folder to your server");?>
.
              </div>
            </div>
...
?>
              ...
              <div>
                <div class="form-control-label h6"><?php echo __("Google Cloud");?>
</div>
                <div class="form-text d-none d-sm-block">
...
?>
        ...
        <div class="form-table-row">
          <div class="avatar">
            <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"html",'width'=>"40px",'height'=>"40px"), 0, true);
?>
          </div>
          <div>
            <div class="form-control-label h6"><?php echo __("HTML Enabled");?>
</div>
...
?>
                ...
                <div>
                  <div class="form-control-label h6"><?php echo __("Stripe Enabled");?>
</div>
...
?>
                ...
                <div>
                  <div class="form-control-label h6"><?php echo __("Razorpay Enabled");?>
</div>
...
/images/cashfree.png">
                ...
                <div>
                  <div class="form-control-label h6"><?php echo __("Cashfree Enabled");?>
</div>
              ...
              <div class="form-group form-row">
                ...
                <div class="col-md-9">
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="cashfree_mode" id="Cashfree_live" value="live" class="custom-control-input" <?php if ($_smarty_tpl->tpl_vars['system']->value['cashfree_mode'] == "live") {?>checked<?php }?>>
                    <label class="custom-control-label" for="Cashfree_live"><?php echo __("Live");?>
</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="cashfree_mode" id="Cashfree_sandbox" value="sandbox" class="custom-control-input" <?php if ($_smarty_tpl->tpl_vars['system']->value['cashfree_mode'] == "sandbox") {?>checked<?php }?>>
                    <label class="custom-control-label" for="Cashfree_sandbox"><?php echo __("Sandbox");?>
</label>
                  </div>
                </div>
              </div>
...
?>
                ...
                <div>
                  <div class="form-control-label h6"><?php echo __("Coinbase Enabled");?>
</div>
...
?>
                ...
                <div>
                  <div class="form-control-label h6"><?php echo __("SecurionPay Enabled");?>
</div>
