...
/* Smarty version 4.1.1, created on 2022-09-26 13:52:19
  from '/home/u0725988/public_html/content/themes/default/templates/_js_templates.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6331ae931bcd30_27384620',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fb3c9d1e5d0c54ed69190fa4cf8eccf52cffee32' => 
    array (
      0 => '/home/u0725988/public_html/content/themes/default/templates/_js_templates.tpl',
      1 => 1652093040,
      2 => 'file',
    ),
  ),
...
function content_6331ae931bcd30_27384620 (Smarty_Internal_Template $_smarty_tpl) {
...
" alt="" /></div><div class="data-content"><div class="float-right"><i class="fa fa-circle <?php if ($_smarty_tpl->tpl_vars['_user']->value['user_is_online']) {?>online<?php } else { ?>offline<?php }?>"></i></div><div><strong><?php if ($_smarty_tpl->tpl_vars['system']->value['show_usernames_enabled']) {?> <?php echo $_smarty_tpl->tpl_vars['_user']->value['user_name'];?>
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['_user']->value['user_firstname'];?>
 <?php echo $_smarty_tpl->tpl_vars['_user']->value['user_lastname'];?>
 <?php }?></strong><?php if ($_smarty_tpl->tpl_vars['system']->value['chat_status_enabled'] && !$_smarty_tpl->tpl_vars['_user']->value['user_is_online']) {?><br /><small> <?php ob_start();
echo __("Last Seen");
...
if ($_smarty_tpl->tpl_vars['system']->value['razorpay_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#razorpay" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}" }'><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"razorpay",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("Razorpay");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['cashfree_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#cashfree" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}" }'><img width="20px" height="20px" src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->tpl_vars['system']->value['theme'];?>
/images/cashfree.png" class="mr5"><?php echo __("Cashfree");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['coinbase_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-coinbase btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}}><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"coinbase",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("Coinbase");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['securionpay_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-securionpay btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}}><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"securionpay",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("SecurionPay");?>
</button></div><?php }
...
echo '<script'; ?>
 id="razorpay" type="text/template"><div class="modal-header"><h6 class="modal-title"><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"razorpay",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("Razorpay");?>
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><form id="razorpay_form"><div class="modal-body"><div class="row"><div class="form-group col-md-6"><label class="form-control-label"><?php echo __("Name");?>
</label><input name="billing_name" type="text" class="form-control" required value="<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['name'];?>
" /></div><div class="form-group col-md-6"><label class="form-control-label"><?php echo __("Email");?>
</label><input name="billing_email" type="email" class="form-control" required value="<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_email'];?>
" /></div><div class="form-group col-md-6"><label class="form-control-label"><?php echo __("Phone");?>
</label><input name="billing_phone" type="text" class="form-control" required value="<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_phone'];?>
" /></div></div><!-- error --><div class="alert alert-danger mb0 x-hidden"></div><!-- error --></div><div class="modal-footer"><input type="hidden" name="handle" value="{{handle}}" /><input type="hidden" name="id" value="{{id}}" /><input type="hidden" name="price" value="{{price}}" /><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
</button><button type="submit" class="btn btn-primary"><i class="fa fa-check-circle mr10"></i><?php echo __("Pay");?>
</button></div></form><?php echo '</script'; ?>
><?php }?><!-- Razorpay --><!-- Cashfree --><?php if ($_smarty_tpl->tpl_vars['system']->value['cashfree_enabled']) {
echo '<script'; ?>
 id="cashfree" type="text/template"><div class="modal-header"><h6 class="modal-title"><img width="20px" height="20px" src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->tpl_vars['system']->value['theme'];?>
/images/cashfree.png" class="mr5"><?php echo __("Cashfree");?>
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><form id="cashfree_form"><div class="modal-body"><div class="row"><div class="form-group col-md-6"><label class="form-control-label"><?php echo __("Name");?>
</label><input name="billing_name" type="text" class="form-control" required value="<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['name'];?>
" /></div><div class="form-group col-md-6"><label class="form-control-label"><?php echo __("Email");?>
</label><input name="billing_email" type="email" class="form-control" required value="<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_email'];?>
" /></div><div class="form-group col-md-6"><label class="form-control-label"><?php echo __("Phone");?>
